...
agent = Agent(200, 20, alpha=.01, gamma=.95, epsilon=.3, epsilon_lower=.3, epsilon_decay=.99)
...
def take_action(action):
    ...
    episode_steps += 1
    # print(f'Episode reward: {episode_reward} - Episode steps: {episode_steps} - Reward: {reward} - Action: {action} - ')
